...
if ticker:
    ...
    with t_chart:
        ...
        # 2. Horizontal Volume Profile Overlay (Left side)
        ...
        # 3. Horizontal Price Lines (POC & Current Price only)
        fig_main.add_hline(y=poc_mid, line_dash="dash", line_color="red", line_width=1, annotation_text="POC")
        fig_main.add_hline(y=curr_p, line_dash="solid", line_color="#00FF00", line_width=1, annotation_text="NOW")
        ...
        fig_main.update_layout(
            ...
            # Setup for White Dotted Spikes (Crosshair)
            xaxis=dict(
                showspikes=True,
                spikemode='across',
                spikedash='dot',
            ...
            # Volume Profile Axis Configuration
            xaxis2=dict(
                overlaying='x',
                side='top',
                showgrid=False,
                showticklabels=False,
                range=[0, max(counts) * 4] 
            ),
